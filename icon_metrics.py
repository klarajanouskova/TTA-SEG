...
class MAE(object):
    ...
    @staticmethod
    def cal_mae(pred: np.ndarray, gt: np.ndarray) -> float:
...
class MSE(object):
    ...
    @staticmethod
    def cal_mse(pred: np.ndarray, gt: np.ndarray) -> float:
...
class IoU(object):
    ...
    @staticmethod
    def cal_iou(pred: np.ndarray, gt: np.ndarray) -> float:
    ...
    def get_results(self) -> dict:
        iou = np.mean(np.array(self.ious, _TYPE))
        return dict(iou=iou)
