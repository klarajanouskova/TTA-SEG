...
def save_model(args, epoch, model, model_without_ddp, optimizer, loss_scaler=None, best=False, last=False):
    # TODO simplify this
    output_dir = Path(args.output_dir)
    epoch_name = str(epoch)
    if loss_scaler is not None:
        checkpoint_paths = [output_dir / args.exp_name / ('checkpoint-%s.pth' % epoch_name)]
        for checkpoint_path in checkpoint_paths:
            ...
            if best:
                save_on_master(to_save, output_dir / args.exp_name / 'checkpoint-best.pth')
            elif last:
                save_on_master(to_save, output_dir / args.exp_name / 'checkpoint-last.pth')
            else:
