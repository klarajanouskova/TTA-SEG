...
class Sam(nn.Module):
    ...
    def postprocess(self, x: torch.Tensor, size) -> torch.Tensor:
        """Remove padding and denormalize pixel values."""
        x = x[..., : size[0], : size[1]]
    ...
    def freeze_seg_decoder(self):
        """
        Freeze the segmentation decoder.
        """
    ...
    def freeze_prompt_encoder(self):
        ...
        """
        for name, p in self.prompt_encoder.named_parameters():
            p.requires_grad = False
