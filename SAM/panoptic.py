...
# adapted from  https://github.com/mcordts/cityscapesScripts/blob/master/cityscapesscripts/evaluation/evalPanopticSemanticLabeling.py
# python imports
...
def convert2panoptic(cityscapesPath=None, outputFolder=None, useTrainId=False, setNames=["val", "train", "test"]):
    ...
    for setName in setNames:
        ...
        panopticFolder = os.path.join(outputFolder, outputBaseFile, setName)
        ...
        for progress, f in enumerate(files):
            ...
            city_folder = f.split('/')[-2]
            save_folder = os.path.join(panopticFolder, city_folder)
            ...
            # TODO fix this in case we need panoptic, not just entity segmentation
            file_path = os.path.join(panopticFolder, outputFileName)
            annotations.append({'image_id': imageId,
                                'file_name': outputFileName,
                                "segments_info": segmInfo})

            Image.fromarray(pan_format).save(os.path.join(save_folder, outputFileName))
...
def main():
    ...
    parser.add_argument("--dataset-folder",
                        ...
                        default='/datagrid/TextSpotter/klara/datasets/cityscapes/gtFine',
                        type=str)
    parser.add_argument("--output-folder",
                        dest="outputFolder",
                        help="path to the output folder.",
                        default='/datagrid/TextSpotter/klara/datasets/cityscapes/gtFinePanoptic',
                        type=str)
